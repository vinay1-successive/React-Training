      ...
      <div style={{ display: "flex", width: "100vw", flexDirection: "column" }}>
        <Routes>
          <Route path="/" element={<Links props={linkTextMain2}/>}>
            ...
            <Route
              path="/question3"
              element={<TodoList styles={styleAll} value={Question.TodoList} />}
            />
            <Route
              path="/question4"
              element={
            ...
            <Route
              path="/question7"
              element={
                <Notification styles={styleAll} value={Question.Notification} />
              }
            />
            <Route
              path="/question8"
            ...
            <Route
              path="/question11"
              element={
                <ShoppingCart styles={styleAll} value={Question.ShoppingCart} />
              }
            />
            <Route
              path="/question12"
            ...
            <Route
              path="/question14"
              element={<TaskList styles={styleAll} value={Question.TaskList} />}
            />
            <Route
              path="/question15"
              element={
